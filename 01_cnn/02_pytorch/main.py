...
@description:
Script contains the major logic of this assignment and can be used to train and validate the implemented CNN.
...
from models import TwoLayerNet, VanillaCNN

parser = argparse.ArgumentParser(description='Assignment-3 Part PyTorch')
